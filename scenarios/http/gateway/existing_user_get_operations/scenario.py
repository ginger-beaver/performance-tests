...
class GetOperationsTaskSet(GatewayHTTPTaskSet):
    ...
    def get_operations(self):
        self.operations_gateway_client.get_operations(self.seed_user.credit_card_accounts[0].account_id)

    @task(2)
    def get_operations_summary(self):
        self.operations_gateway_client.get_operations_summary(self.seed_user.credit_card_accounts[0].account_id)
